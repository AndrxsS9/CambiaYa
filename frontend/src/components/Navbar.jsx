...
import { LogOut, User, Package, Repeat, MessageSquare, ArrowLeftRight } from 'lucide-react';
...
const Navbar = () => {
  ...
  // Extraer un nombre legible del currentUser
        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <Link to="/" className="flex items-center space-x-2 group">
            ...
            <span className="text-xl font-bold text-slate-800 tracking-tight">
              Cambia<span className="text-blue-600">Ya</span>
            </span>
          </Link>
          ...
          <div className="flex items-center space-x-6">
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-4">
                <Link to="/chats" className="flex items-center space-x-1 text-slate-600 hover:text-blue-600 font-medium transition-colors">
                  <MessageSquare size={18} />
                  <span>Mensajes</span>
                </Link>
                <Link to="/history" className="flex items-center space-x-1 text-slate-600 hover:text-blue-600 font-medium transition-colors">
